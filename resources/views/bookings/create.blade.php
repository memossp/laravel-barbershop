    ...
    <div class="former-wrap">
        ...
        <form action="{{ route('bookings.store') }}" method="POST">
                ...
                <div class="cuts-col">
                    <label for="haircut">
                        <input type="checkbox"
                               ...
                               name="services[]"
                               value="haircut"
                            {{ in_array('haircut', old('services', [])) ? 'checked' : '' }}>
                        Haircut 12$
                    </label>
                </div>
                <div class="cuts-col">
                    <label for="shave">
                        <input type="checkbox"
                               ...
                               name="services[]"
                               value="shave"
                            {{ in_array('shave', old('services', [])) ? 'checked' : '' }}>
                        Shave 6$
                    </label>
                </div>
                <div class="cuts-col">
                    <label for="beardtrim">
                        <input type="checkbox"
                               ...
                               name="services[]"
                               value="beardtrim"
                            {{ in_array('beardtrim', old('services', [])) ? 'checked' : '' }}>
                        Beard Trim 6$
                    </label>
                </div>
            </div>
            ...
            <textarea id="comments"
                      name="comments"
                      class="@error('comments') is-invalid @enderror">{{ old('comments') }}</textarea>
            @error('comments')
            <span class="invalid-feedback">{{ $message }}</span>
            @enderror
